...
// initializing
let innerHTML = ref('');
let searchAblePostOffice = ref(Object.keys(props.permanentAddress).length == 0 ? props.translations.biodata_form.personal_biodata.permanent_address_title : props.permanentAddress.selectedPostOffice +' - '+ props.permanentAddress.selectedPostCode);
