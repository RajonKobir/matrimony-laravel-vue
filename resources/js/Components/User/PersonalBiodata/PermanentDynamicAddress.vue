...
// initializing
let innerHTML = ref('');
let selectedPermanentUpazilaAndUnionParishad = ref(props.permanentAddress.selectedUpazila == null || props.permanentAddress.selectedUnionParishad == null ? props.translations.biodata_form.personal_biodata.permanent_address_title : props.permanentAddress.selectedUpazila +' - '+ props.permanentAddress.selectedUnionParishad);
