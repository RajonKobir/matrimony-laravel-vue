...
// initializing
let innerHTML = ref('');
let selectedTemporaryUpazilaAndUnionParishad = ref(props.temporaryAddress.selectedUpazila == null || props.temporaryAddress.selectedUnionParishad == null ? props.translations.biodata_form.personal_biodata.temporary_address_title : props.temporaryAddress.selectedUpazila +' - '+ props.temporaryAddress.selectedUnionParishad);
