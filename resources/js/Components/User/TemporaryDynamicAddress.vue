...
// initializing
let innerHTML = ref('');
let searchAblePostOffice = ref(Object.keys(props.temporaryAddress).length == 0 ? props.translations.biodata_form.personal_biodata.temporary_address_title : props.temporaryAddress.selectedPostOffice +' - '+ props.temporaryAddress.selectedPostCode);
