...
document.body.classList.add("backend.biodata.completed");
        ...
        <table id="myTable" class="display">
            ...
            <tbody>
                ...
                :key="single_biodata.id">
                    <tr v-if="!single_biodata.is_approved && single_biodata.is_approved != 1 && parseInt(single_biodata.biodata_completion) == 100">
